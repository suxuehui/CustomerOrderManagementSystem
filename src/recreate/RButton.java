package recreate;
/*
 此类重绘JButton产生RButton类，Rbutton类为一个圆角按钮类
  */
...
public class RButton extends JButton {  
    ...
    public static final Color BUTTON_COLOR1 = new Color(30, 144, 255);  
    public static final Color BUTTON_COLOR2 = new Color(30, 144, 255);  
